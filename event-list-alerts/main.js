...
const twitchClientId = "slug4swsmvmf1s2e2xoowp824aioif"
const twitchClientSecret = "0t5h3jifbdno2npvdbqwcoxkh3pyjq"
const streamlabsSocketToken = "null"
const streamelementsJWTToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..IMhtPJIM_K4yPBttS-NO7TH1VmQLCfkEJHjL8g1Phzc"
const broadcasterName = "VeryVeryGrae"
...
client.on("resub", function(channel, username, streak, message, tags, methods) {
	...
	addAlert({username: username, name: tags['display-name'], showPFP: true, html: alertHtml, audio: "vine.mp3"});
});
